  ...
  return (
    <section className="max-container">
      <h1 className='head-text'>
        Hey, We Are <span className='blue-gradient_text font-semibold drop-shadow'>Media Mahasiswa Creative</span>
      </h1>
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          A versatile full-stack web developer based in Indonesia. Crafting seamless digital experiences through innovative coding and design solutions.
